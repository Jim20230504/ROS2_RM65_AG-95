...
static const _GripperState_type_support_symbol_names_t _GripperState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dh_gripper_msgs, msg, GripperState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, dh_gripper_msgs, msg, GripperState)),
  }
};
...
{
  return &::dh_gripper_msgs::msg::rosidl_typesupport_cpp::GripperState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, dh_gripper_msgs, msg, GripperState)() {
  return get_message_type_support_handle<dh_gripper_msgs::msg::GripperState>();
}
